...
export const fahrten: Fahrt[] = [
  { id: 'ft1', fahrtNummer: '#114151', typ: 'krankenfahrt', datum: '2026-03-21', uhrzeit: '08:00', von: 'Charité Mitte', nach: 'Vivantes Neukölln', fahrerId: 'fa1', fahrzeugId: 'fz1', status: 'erledigt', preis: 85, mwst: 7, kunde: 'AOK Berlin', kommentare: [{ id: 'k1', text: 'Patient pünktlich abgeholt', datum: '2026-03-21T08:15', autor: 'Disposition' }] },
  { id: 'ft2', fahrtNummer: '#114152', typ: 'flughafentransfer', datum: '2026-03-21', uhrzeit: '14:30', von: 'Hotel Adlon', nach: 'BER Terminal 1', fahrerId: 'fa2', fahrzeugId: 'fz3', status: 'erledigt', preis: 120, mwst: 19, kunde: 'Hotel Adlon Kempinski', kommentare: [] },
  { id: 'ft3', fahrtNummer: '#114153', typ: 'privatfahrt', datum: '2026-03-21', uhrzeit: '18:00', von: 'Alexanderplatz', nach: 'Potsdam Hbf', fahrerId: 'fa3', fahrzeugId: 'fz2', status: 'geplant', preis: 95, mwst: 19, kommentare: [] },
  { id: 'ft4', fahrtNummer: '#114154', typ: 'firmenfahrt', datum: '2026-03-20', uhrzeit: '09:00', von: 'Siemensstadt', nach: 'Messe Berlin', fahrerId: 'fa4', fahrzeugId: 'fz1', status: 'erledigt', preis: 65, mwst: 19, kunde: 'Siemens AG', kommentare: [{ id: 'k2', text: 'Rückfahrt ebenfalls gebucht', datum: '2026-03-20T09:30', autor: 'Office' }] },
  { id: 'ft5', fahrtNummer: '#114155', typ: 'krankenfahrt', datum: '2026-03-20', uhrzeit: '10:30', von: 'DRK Westend', nach: 'Charité Campus Virchow', fahrerId: 'fa1', fahrzeugId: 'fz5', status: 'erledigt', preis: 55, mwst: 7, kunde: 'Barmer', kommentare: [] },
  { id: 'ft6', fahrtNummer: '#114156', typ: 'flughafentransfer', datum: '2026-03-20', uhrzeit: '05:00', von: 'Friedrichshain', nach: 'BER Terminal 1', fahrerId: 'fa2', fahrzeugId: 'fz3', status: 'erledigt', preis: 89, mwst: 19, kommentare: [] },
  { id: 'ft7', fahrtNummer: '#114157', typ: 'privatfahrt', datum: '2026-03-19', uhrzeit: '20:00', von: 'Kurfürstendamm', nach: 'Tegel', fahrerId: 'fa3', fahrzeugId: 'fz2', status: 'erledigt', preis: 45, mwst: 19, kommentare: [] },
  { id: 'ft8', fahrtNummer: '#114158', typ: 'firmenfahrt', datum: '2026-03-19', uhrzeit: '07:30', von: 'Potsdamer Platz', nach: 'Adlershof Science Park', fahrerId: 'fa4', fahrzeugId: 'fz1', status: 'erledigt', preis: 78, mwst: 19, kunde: 'Deutsche Telekom', kommentare: [] },
  { id: 'ft9', fahrtNummer: '#114159', typ: 'krankenfahrt', datum: '2026-03-22', uhrzeit: '09:00', von: 'Helios Buch', nach: 'Praxis Dr. Müller, Mitte', fahrerId: 'fa1', fahrzeugId: 'fz1', status: 'geplant', kommentare: [] },
  { id: 'ft10', fahrtNummer: '#114160', typ: 'flughafentransfer', datum: '2026-03-22', uhrzeit: '16:00', von: 'BER Terminal 5', nach: 'Marriott Hotel', fahrerId: 'fa2', fahrzeugId: 'fz3', status: 'geplant', preis: 110, mwst: 19, kommentare: [] },
  { id: 'ft11', fahrtNummer: '#114161', typ: 'krankenfahrt', datum: '2026-03-18', uhrzeit: '11:00', von: 'Dialyse Spandau', nach: 'Wohnung Spandau', fahrerId: 'fa3', fahrzeugId: 'fz5', status: 'erledigt', preis: 42, mwst: 7, kunde: 'TK', kommentare: [] },
  { id: 'ft12', fahrtNummer: '#114162', typ: 'privatfahrt', datum: '2026-03-18', uhrzeit: '22:00', von: 'Berghain Nähe', nach: 'Schöneberg', fahrerId: 'fa4', fahrzeugId: 'fz2', status: 'storniert', preis: 35, mwst: 19, kommentare: [{ id: 'k3', text: 'Kunde hat abgesagt', datum: '2026-03-18T21:30', autor: 'Disposition' }] },
  { id: 'ft13', fahrtNummer: '#114163', typ: 'firmenfahrt', datum: '2026-03-17', uhrzeit: '08:00', von: 'Hauptbahnhof', nach: 'EUREF-Campus', fahrerId: 'fa1', fahrzeugId: 'fz3', status: 'erledigt', preis: 58, mwst: 19, kunde: 'Schneider Electric', kommentare: [] },
  { id: 'ft14', fahrtNummer: '#114164', typ: 'krankenfahrt', datum: '2026-03-17', uhrzeit: '14:00', von: 'Unfallkrankenhaus', nach: 'Reha Marzahn', fahrerId: 'fa2', fahrzeugId: 'fz5', status: 'erledigt', preis: 68, mwst: 7, kunde: 'AOK Berlin', kommentare: [] },
  { id: 'ft15', fahrtNummer: '#114165', typ: 'flughafentransfer', datum: '2026-03-23', uhrzeit: '04:30', von: 'Charlottenburg', nach: 'BER Terminal 1', fahrerId: 'fa3', fahrzeugId: 'fz3', status: 'geplant', preis: 95, mwst: 19, kommentare: [] },
  { id: 'ft16', fahrtNummer: '#114166', typ: 'privatfahrt', datum: '2026-03-16', uhrzeit: '15:00', von: 'Zoo Palast', nach: 'Wannsee', fahrerId: 'fa4', fahrzeugId: 'fz2', status: 'erledigt', preis: 52, mwst: 19, kommentare: [] },
  { id: 'ft17', fahrtNummer: '#114167', typ: 'krankenfahrt', datum: '2026-03-19', uhrzeit: '07:00', von: 'Seniorenheim Steglitz', nach: 'Charité Mitte', fahrerId: 'fa1', fahrzeugId: 'fz5', status: 'erledigt', mwst: 7, kunde: 'DAK', notiz: 'Preis noch offen', kommentare: [{ id: 'k4', text: 'Preis fehlt noch, Abrechnung klären', datum: '2026-03-19T10:00', autor: 'Office' }] },
  { id: 'ft18', fahrtNummer: '#114168', typ: 'firmenfahrt', datum: '2026-03-15', uhrzeit: '12:00', von: 'Sony Center', nach: 'Schönefeld Industrie', fahrerId: 'fa2', fahrzeugId: 'fz1', status: 'erledigt', preis: 72, mwst: 19, kunde: 'Sony Europe', kommentare: [] },
];
