...
export default function StatistikIndex() {
  ...
  const hasData = erledigte.length > 0 || ergebnisse.some(e => e.einnahmenGesamt > 0 || e.kostenGesamt > 0);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {!hasData ? (
        <EmptyState
          icon={BarChart3}
          title="Noch nicht genug Daten für Statistiken"
          description="Erfassen Sie Fahrten, Kosten und Plattformumsätze, um hier aussagekräftige Vergleiche und Auswertungen zu sehen."
