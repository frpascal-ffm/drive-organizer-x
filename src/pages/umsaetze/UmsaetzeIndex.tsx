...
export default function UmsaetzeIndex() {
  ...
  const hasAnyData = fahrten.some(f => f.status === "erledigt" && f.preis) || plattformUmsaetze.length > 0;
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {!hasAnyData ? (
        <EmptyState
          icon={TrendingUp}
          title="Noch keine Umsätze vorhanden"
          description="Umsätze entstehen automatisch aus erledigten Fahrten mit Preis und aus importierten Plattformumsätzen. Erfassen Sie eine Fahrt oder importieren Sie einen Plattformbericht."
          actionLabel="Plattform-Import starten"
          actionTo="/umsaetze/import"
        />
      ) : (
        <>
